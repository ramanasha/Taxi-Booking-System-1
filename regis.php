...
if(isset($_SESSION['logged_in'])){
    ...
    header("Location:aboutus.php");
        ...
        if(isset($_POST['submit'])){
          echo '<script src="ext.js">';
                   
                    echo '</script>';
            if($_POST['username']!='' and $_POST['password']!='' and $_POST['email']!=''){
               $data->reg($_POST['username'],md5($_POST['password']),$_POST['email']); 
               $_SESSION['logged_in']= True;
               $_SESSION['username']=$_POST['username'];
               header("Location:aboutus.php");  
            }else {echo '<script src="ext.js">';
...
<div class="a">
<nav class="navbar navbar-default on-top">
...
<form name="f" action="regis.php" method="post"autocomplete="off" >
&nbsp;&nbsp;&nbsp;
<input type="text" name="txtun" placeholder="Username"><BR><br>
&nbsp;&nbsp;&nbsp;
<input type="password" name="txtpw" placeholder="Password"><BR><br>
&nbsp;&nbsp;&nbsp;
<input type="password" name="p" placeholder="Confirm Password"><BR><br>
&nbsp;&nbsp;&nbsp;
<INPUT type="text" NAME="s" placeholder="Email"><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" class="sbutton float-right " value="Submit" onclick="x();" name='submit'>
</FORM>
